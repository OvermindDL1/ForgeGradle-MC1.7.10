...
{
    @Internal
    final private DomainObjectSet<ObfArtifact> obfOutput;
    ...
    public ReobfTask()
    {
        ...
        obfOutput = getProject().getObjects().domainObjectSet(ObfArtifact.class);

        getInputs().files(new Closure<Object>(obfOutput) {
            public Object call(Object... objects)
            {
                return _getFilesToObfuscate();
            }
        });
    ...
    public void doTask() throws Exception
    {
        ...
        for (ObfArtifact obf : _getObfuscated())
     ...
     */
    DomainObjectSet<ObfArtifact> _getObfuscated()
    {
        return obfOutput;
    }
     ...
     */
    FileCollection _getFilesToObfuscate()
    {
        ...
        return getProject().files(collect.toArray(new File[collect.size()]));
    }

    /**
     * All of the signature files that will be generated by this operation.
     */
    FileCollection _getObfuscatedFiles()
    {
        ArrayList<File> collect = new ArrayList<File>();
    ...
    public DomainObjectSet<ObfArtifact> _getObfOutput()
    {
        return obfOutput;
    }
