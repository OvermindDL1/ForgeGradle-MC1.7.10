...
final class DevConstants
{
    ...
    static final String INSTALLER_URL       = "https://gregtech.overminddl1.com/net/minecraftforge/installer/{INSTALLER_VERSION}/installer-{INSTALLER_VERSION}-shrunk.jar";
    static final String LAUNCH4J_URL        = "https://gregtech.overminddl1.com/launch4j/launch4j-3.0.0-"+Constants.OPERATING_SYSTEM+"-"+Constants.SYSTEM_ARCH+".zip";
